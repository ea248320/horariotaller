    ...
    <div className="max-w-3xl">
      ...
      <form onSubmit={save} className="rounded-xl border border-border bg-card p-5">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <label className="block">
            <span className="text-sm font-medium text-foreground">Etiqueta de curso</span>
            <input
          ...
          <label className="block">
            <span className="text-sm font-medium text-foreground">Etiqueta de alumno</span>
            <input
          ...
          <label className="block">
            <span className="text-sm font-medium text-foreground">Color de marca</span>
            <input
              type="color"
          ...
          <label className="flex items-center gap-2 self-end pb-2">
            <input
              ...
              className="h-4 w-4"
            />
            <span className="text-sm font-medium text-foreground">Módulo de cuotas activo</span>
          </label>
        </div>
        {isPreu && (
      ...
      <div className="mt-6 rounded-xl border border-border bg-card p-5">
        <h2 className="text-lg font-bold text-foreground">Plan y facturación</h2>
        {status && (
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`rounded-xl border p-4 ${
                status?.plan.id === plan.id ? 'border-primary ring-1 ring-brand' : 'border-border'
              }`}
            >
              ...
              <button
                ...
                className="mt-3 w-full rounded-lg border border-primary py-1.5 text-sm font-semibold text-primary hover:bg-primary/5"
              >
